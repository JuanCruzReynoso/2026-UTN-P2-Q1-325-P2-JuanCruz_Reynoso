...
Repositorio oficial para la entrega del **Segundo Parcial** de la cursada de Programación II (Tecnicatura Universitaria en Programación - UTN FRA).
...
| **Fecha de Examen** | Viernes 26 de junio - 18:30hs |
...
```bash
git clone https://github.com/JuanCruzReynoso/2026-UTN-P2-Q1-325-P2-JuanCruz_Reynoso.git
```
